            ...
            switch(s) {
                ...
                default:
                    try {
                        ...
                        throw new IllegalInputException("unrecognized input symbol: " + s);
                    }
            }
        } catch (EmptyStackException e) {
            throw new IllegalInputException("attempted operation '" + s + "' on 0- or 1-element stack");
        } catch (SizeLimitReachedException e) {
            throw new SizeLimitReachedException("input too large - arraystack cannot hold more than " + ArrayStack.ARRAY_SIZE + " operands simultaneously");
        } catch (NullPointerException e) {
            throw new IllegalInputException("received empty input");
        }
    }
}
